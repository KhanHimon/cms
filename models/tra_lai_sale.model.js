...
const Tra_lai_sale_Schema = new Schema({
    ...
    cap_tren: [{
        ho_va_ten_cap_tren: {type: String},
        chuc_vu_cap_tren: {type: String},
        cmnd_cap_tren: {type: String},
        hoa_hong_cap_tren: {type: Number},
        tien_thuong_cap_tren: {type: String},
    }],
    ...
    // tien_thuong_nhan_vien: { type: Number, default: 0 },
    ...
    // tien_thuong_truong_nhom: { type: Number, default: 0 },
    ...
    // tien_thuong_truong_phong: { type: Number, default: 0 },
    ...
    // tien_thuong_pho_giam_doc: { type: Number, default: 0 },
    ...
    // tien_thuong_giam_doc: { type: Number, default: 0 },
    ...
    // tien_thuong_giam_doc_vung: { type: Number, default: 0 },
    ...
    // tien_thuong_giam_doc_tinh: { type: Number, default: 0 },
    ...
    // tien_thuong_giam_doc_chien_luoc: { type: Number, default: 0 },
