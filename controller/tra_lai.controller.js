...
class Tra_lai_controller {
    POST_TRA_LAI(req, res) {
        const new_tra_lai = new Tra_lai_sale_Schema({
            ...
            tien_thuong_truong_nhom: (req.body.so_tien_dau_tu * ((req.body.hoa_hong_truong_nhom - req.body.hoa_hong) / 100)),
            ...
            tien_thuong_giam_doc_tinh: (req.body.so_tien_dau_tu * (req.body.tien_thuong_giam_doc_tinh / 100)),
            ...
            tien_thuong_giam_doc: (req.body.so_tien_dau_tu * (req.body.hoa_hong_giam_doc_vung / 100)),
