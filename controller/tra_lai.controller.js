    ...
    POST_TRA_LAI(req, res) {
        ...
        Hop_dong_dau_tu_Schema.findByIdAndUpdate(req.params._id, { $set: edit_trang_thai }, options, (err, update_hop_dong) => {
            const new_tra_lai = new Tra_lai_sale_Schema({
                ...
                so_tai_khoan_nhan_vien: req.body.so_tai_khoan_nhan_vien,
                ngan_hang_nhan_vien: req.body.ngan_hang_nhan_vien,
                ma_gioi_thieu_nhan_vien: req.body.ma_gioi_thieu_nhan_vien,
                ...
                so_tai_khoan_truong_nhom: req.body.so_tai_khoan_truong_nhom,
                ngan_hang_truong_nhom: req.body.ngan_hang_truong_nhom,
                ma_gioi_thieu_truong_nhom: req.body.ma_gioi_thieu_truong_nhom,
                ...
                so_tai_khoan_truong_phong: req.body.so_tai_khoan_truong_phong,
                ngan_hang_truong_phong: req.body.ngan_hang_truong_phong,
                ma_gioi_thieu_truong_phong: req.body.ma_gioi_thieu_truong_phong,
                ...
                so_tai_khoan_pho_giam_doc: req.body.so_tai_khoan_pho_giam_doc,
                ngan_hang_pho_giam_doc: req.body.ngan_hang_pho_giam_doc,
                ma_gioi_thieu_pho_giam_doc: req.body.ma_gioi_thieu_pho_giam_doc,
                ...
                so_tai_khoan_giam_doc: req.body.so_tai_khoan_giam_doc,
                ngan_hang_giam_doc: req.body.ngan_hang_giam_doc,
                ma_gioi_thieu_giam_doc: req.body.ma_gioi_thieu_giam_doc,
                ...
                so_tai_khoan_giam_doc_tinh: req.body.so_tai_khoan_giam_doc_tinh,
                ngan_hang_giam_doc_tinh: req.body.ngan_hang_giam_doc_tinh,
                ma_gioi_thieu_giam_doc_tinh: req.body.ma_gioi_thieu_giam_doc_tinh,
                ...
                cmnd_cccd_giam_doc: req.body.cmnd_cccd_giam_doc,
                so_tai_khoan_giam_doc_vung: req.body.so_tai_khoan_giam_doc_vung,
                ngan_hang_giam_doc_vung: req.body.ngan_hang_giam_doc_vung,
                ma_gioi_thieu_giam_doc_vung: req.body.ma_gioi_thieu_giam_doc_vung,
                ...
                so_tai_khoan_giam_doc_chien_luoc: req.body.so_tai_khoan_giam_doc_chien_luoc,
                ngan_hang_giam_doc_chien_luoc: req.body.ngan_hang_giam_doc_chien_luoc,
                ma_gioi_thieu_giam_doc_chien_luoc: req.body.ma_gioi_thieu_giam_doc_chien_luoc,
