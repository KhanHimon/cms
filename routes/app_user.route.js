...
router.get('/about', APP_USER_CONTROLLER.GET_HOME_ABOUT);
router.get('/faq', APP_USER_CONTROLLER.GET_HOME_FAQ);
router.get('/contact', APP_USER_CONTROLLER.GET_HOME_CONTACT);
